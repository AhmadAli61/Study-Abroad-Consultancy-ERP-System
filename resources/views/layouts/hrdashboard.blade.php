...
<i class="menu-icon fa-solid fa-user-tie fs-6"></i>
   ...
   <a href="#" class="menu-link menu-toggle">
    <i class="menu-icon fa-solid fa-circle-nodes fs-6"></i>
    <div>HR Management Hub</div>
</a>
    ...
    <ul class="menu-sub">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href={{ route('hr.add-staff') }} class="menu-link">
                        <i class="fa-solid fa-user-plus me-2"></i>
                        <div>Add Staff</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href={{ route('hr.all-staff') }} class="menu-link">
