            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item active open">
                        <a href= {{route('admissionagent.dashboard')}} class="menu-link">
                            <i class="menu-icon fa-solid fa-house fs-6"></i>
                            <div>Dashboard</div>
                        </a>
                    </li>
                 <li class="menu-item">
    <a href="{{ route('admissionagent.all-intakes') }}" class="menu-link">
        ...
        <div>
            <i class="fas fa-file-alt me-2"></i>All Intakes
                    ...
                    <li class="menu-item">
    <a href="{{ route('admission-agent.inquiry.reminder') }}" class="menu-link">
        ...
        <div>Reminders</div>
            ...
            <livewire:admission-agent.reminder-checker wire:poll.30s />
