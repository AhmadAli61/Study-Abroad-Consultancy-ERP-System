<div>
        ...
        <div>
            <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-2">
                    <i class="fas fa-snowflake fa-lg text-white"></i>
                    <h4 class="mb-0 text-white"><strong>Cold Inquiries</strong></h4>
                </div>
    ...
    @endif
                                ...
                                <td class="whitespace-normal break-words max-w-[150px]"
                                ...
                                <td
                                    ...
                                    <span class="badge text-white"
                                        style="font-size: 13px; padding: 4px 6px; background-color: #00c0ff;"
    ...
    <livewire:manager.modalmanager.modalcoldinquiries 
        wire:key="modal-cold-inquiries-{{ time() }}" />
