<div>
    <div class="card">
        <div>
            <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #f1bf28; color: black;">
                <div class="d-flex align-items-center gap-2">
                    <i class="fas fa-exclamation-circle fa-lg " style="color: #000"></i>
                    <h4 class="mb-0" style="color: black"><strong>Pending Inquiries</strong></h4>
                </div>
...
@endif
    ...
    <style>
        @keyframes blink {
            ...
            100% { opacity: 1; }
                            ...
                            <td class="whitespace-normal break-words max-w-[150px]" style="padding: 6px; word-break: break-word; overflow-wrap: break-word;">
                            ...
                            <td style="vertical-align: middle; padding: 8px; white-space: nowrap; text-align: center;">
                                <span class="badge" 
                                    ...
                                    <strong>{{ ucfirst($inquiry->inquiry_status ?? 'Pending') }}</strong>
                                </span>
                            </td>
                            <td style="vertical-align: middle; padding: 8px; white-space: nowrap; text-align: center;">
    ...
    <livewire:manager.modalmanager.modalpendinginquiries 
        wire:key="modal-pending-inquiries-{{ time() }}" />
