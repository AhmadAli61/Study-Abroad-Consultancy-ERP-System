        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="mb-0 opacity-75">
                    Transfer student inquiries between team members
                </p>
            </div>
            <div class="col-md-4 text-end">
                <div class="input-group" style="border-radius: 10px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    <input type="text" 
                           ...
                           wire:keyup="searches"
                           style="border-radius: 0; font-size: 14px; padding: 12px 20px;">
                    <button class="btn" 
                            style="background: rgba(5, 5, 5, 0.2); color: white; border: none; padding: 12px 20px;">
        ...
        <table class="table align-middle table-hover text-center" style="border-radius: 16px; overflow: hidden;">
            <thead class="bg-primary" style=" border-bottom: 1px solid #dee2e6;">
                <tr>
                    ...
                    <th class="text-white"><i class="fas fa-user me-1 text-white"></i> Name</th>
                    <th class="text-white"><i class="fas fa-phone me-1 text-white"></i> Phone</th>
    ...
    @endif
                        ...
                        <td>
                            <select wire:model="selectedUser.{{ $inquiry->id }}" class="form-select"
                                ...
                                @if($users instanceof \Illuminate\Support\Collection && $users->isNotEmpty())
                                @foreach($users as $user)
                    ...
                    <tr>
                        <td colspan="7" class="text-center" style="padding: 40px 0;">
                            <div style="opacity: 0.7;">
                                ...
                                <h5 style="font-weight: 600;">No Inquiries Found</h5>
