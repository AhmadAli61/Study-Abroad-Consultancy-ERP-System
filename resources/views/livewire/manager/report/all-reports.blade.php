                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-white mb-0 opacity-75" style="font-size: 1.1rem;">
                                        <i class="fas fa-user-tie me-2"></i>{{ Auth::user()->name ?? 'Manager' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="border-radius: 15px; transition: all 0.3s ease; border-left: 4px solid #9b59b6;">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h6 class="card-title text-muted mb-2" style="font-size: 0.9rem; font-weight: 600;">REGISTRATIONS</h6>
                                            <h3 class="mb-0" style="font-weight: 800; color: #2c3e50;">
                                                {{ $reports->sum('today_registration') }}
                                            </h3>
                                        </div>
                                                        ...
                                                        <td style="padding: 8px; vertical-align: middle; border-right: 1px solid #f1f3f4;">
                                                            <div class="compact-metrics">
                                                                ...
                                                                <div class="d-flex justify-content-between text-center" style="gap: 2px; margin-bottom: 4px;">
                                                                    ...
                                                                    <div style="flex: 1;">
                                                                        <div style="font-weight: 800; color: #2c3e50; font-size: 0.85rem; line-height: 1.1;">{{ $report->today_registration ?? 0 }}</div>
                                                                        <small class="text-muted" style="font-size: 0.55rem;">Registrations</small>
                                                                    </div>
                                                                    <div style="flex: 1;">
                                                                        <div style="font-weight: 800; color: #2c3e50; font-size: 0.85rem; line-height: 1.1;">{{ $report->applications_processed ?? 0 }}</div>
                                                            ...
                                                            <div class="lead-status-grid">
                                                                ...
                                                                <div class="mt-2 pt-2" style="border-top: 1px dashed #e0e0e0;">
                                                                    <div class="d-flex justify-content-between align-items-center">
                                                                        ...
                                                                        <span style="font-weight: 800; color: #2c3e50; font-size: 0.85rem;">{{ $report->total_leads ?? ($report->hot_leads + $report->cold_leads + $report->dead_leads + $report->pending_leads) }}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-2">
                                                            ...
                                                            <strong style="color: #2c3e50;">{{ $report->today_registration ?? 0 }}</strong>
                                                        </div>
                                                        <div>
                                                            <small class="text-muted d-block">Applications</small>
                                                            <strong style="color: #2c3e50;">{{ $report->applications_processed ?? 0 }}</strong>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="row g-2">
                                                        ...
                                                        <div class="col-6">
                                                            <span class="badge w-100 px-2 py-2" style="background: rgba(255, 193, 7, 0.1); color: #b7950b; border: 1px solid rgba(255, 193, 7, 0.3); border-radius: 6px; font-size: 0.75rem;">
