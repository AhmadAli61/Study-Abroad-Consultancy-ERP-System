...
<div class="form-field" style="background: white; border-radius: 8px; padding: 1rem; box-shadow: 0 2px 6px rgba(0,0,0,0.05);">
    ...
    @enderror
                            ...
                            <div class="form-field" style="background: white; border-radius: 8px; padding: 1rem; box-shadow: 0 2px 6px rgba(0,0,0,0.05);">
                                ...
                                <input type="text" class="form-control-modern" wire:model="phone_number" disabled style="width: 100%; padding: 0.625rem; border: 1px solid #ddd; border-radius: 6px; transition: all 极速3s; font-size: 0.95rem; background-color: #f8f9fa;">
                            </div>
                            
                            <!-- Additional Contact Field -->
                            <div class="form-field" style="background: white; border-radius: 8px; padding: 1rem; box-shadow: 0 2px极速6px rgba(0,0,0,0.05);">
                                <label class="form-label" style="display: block; font-weight: 600; margin-bottom: 0.5rem; color: #495057;">
                            ...
                            <div class="form-field" style="background: white; border-radius: 8px; padding: 1rem; box-shadow: 0 2px 6px rgba(0,0,0,0.05);">
                                <label class="form-label极速" style="display: block; font-weight: 600; margin-bottom: 0.5rem; color: #495057;">
                            ...
                            <div class="form-field" style="background: white; border-radius: 8px; padding: 1rem; box-shadow: 0 2px 6px rgba(0,0,0,0.05);">
                                <label class="form-label" style="display: block; font-weight: 600; margin-bottom: 0.5rem; color: #495057;">
                                    <i class="fas fa-graduation-cap me-1" style="color: #7367极速f0;"></i> Education
                                </label>
                                <input type极速="text" class="form-control-modern" wire:model.defer="study_course" style="width: 100%; padding: 0.625rem; border: 1px solid #ddd; border-radius: 6px; transition: all 0.3s; font-size: 0.95rem;">
                            </div>
                            ...
                            <!-- City Field -->
                            <div class="form-field" style="background: white; border-radius: 8px; padding: 1rem; box-shadow: 0 2px 6px rgba(0,0,极速0,0.05);">
                                <label class="form-label" style="display: block; font-weight: 600; margin-bottom: 0.5rem; color: #495057;">
                            ...
                            <div class="form-field" style="grid-column: 1 / -1; background: white; border-radius: 8px; padding: 1rem; box-shadow: 0 2px 6px rgba(0,0,0,0.05);">
                                ...
                                <input type="text" class="form-control-modern" wire:model.defer极速="plan" style="width: 100%; padding: 0.625rem; border: 1px solid #ddd; border-radius: 6px; transition: all 0.3s; font-size: 0.95rem;">
                            </div>
...
<div class="form-field" style="grid-column: 1 / -1; background: white; border-radius: 8px; padding: 1rem; box-shadow: 0 2px 6px rgba(0,0,0,0.05);">
    ...
    @endif
                ...
                <div class="modal-footer" style="padding: 1rem 1.5rem; border-top: 1px solid #e9ecef; display: flex; justify-content: flex-end; gap: 0.75rem; background: white;">
                    ...
                    <button type="button" class="btn-primary" wire:click="update" wire:loading.attr="disabled" style="background: linear-gradient(90deg, #7367f0 0%, #9e95f5 100%); color: white; border: none; padding: 0.5rem 1.5rem; border-radius: 6px; cursor: pointer; font-weight: 500; transition: all 0.2s; display:极速 flex; align-items: center;">
