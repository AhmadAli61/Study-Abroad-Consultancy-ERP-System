                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-end">
                        ...
                        <div class="bg-white bg-opacity-20 p-3 rounded d-inline-block">
                            <h3 class="mb-0 text-dark">{{ $totalCount ?? 0 }}</h3>
            ...
            <div class="row mb-4">
                <div class="col-12 mb-4">
                    <div class="d-flex justify-content-between align-items-center p-3 rounded shadow-sm" 
                        ...
                        <a href="{{ route('manager.inquiries') }}" 
                ...
                <div class="row mb-2 d-flex justify-content-between flex-wrap" style="display: flex; flex-wrap: wrap; justify-content: space-between;">
                    ...
                    <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
                        <a href="{{ route('manager.inquiries') }}" class="text-decoration-none">
                    ...
                    {{-- Hot Leads --}}
                    <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
                        <a href="{{ route('manager.inquiry.hot') }}" class="text-decoration-none">
                    ...
                    {{-- Cold Leads --}}
                    <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
                        <a href="{{ route('manager.inquiry.cold') }}" class="text-decoration-none">
                    ...
                    {{-- Dead Leads --}}
                    <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
                        <a href="{{ route('manager.inquiry.dead') }}" class="text-decoration-none">
                    ...
                    {{-- Pending Leads --}}
                    <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
                        <a href="{{ route('manager.inquiry.pending') }}" class="text-decoration-none">
                            <div class="card text-center"
            ...
            <div class="row mb-4">
                <div class="col-12 mb-4">
                    <div class="d-flex justify-content-between align-items-center p-3 rounded shadow-sm" 
                        ...
                        <a href="{{ route('manager.admission-dashboard') }}" 
                           class="btn btn-sm fw-semibold"
...
<div class="d-flex flex-wrap justify-content-center" style="gap: 10px;">
            ...
            <div class="card text-center" style="background-color: #517577; height: 160px; border: none; box-shadow: 0 4px 6px rgba(0,0,0,0.1); color: black;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h3 class="fw-bold m-0 text-white">{{ $underAssessmentCount ?? 0 }}</h3>
                    </div>
            ...
            <div class="card text-center" style="background-color: #09122C; height: 160px; border: none; box-shadow: 0 4px 6px rgba(0,0,0,0.1); color: white;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h3 class="fw-bold m-0 text-white">{{ $processedCount ?? 0 }}</h3>
                    </div>
            ...
            <div class="card text-center" style="background-color: #27391C; height: 160px; border: none; box-shadow: 0 4px 6px rgba(0,0,0,0.1); color: white;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h3 class="fw-bold m-0 " style="color: rgb(250, 248, 248)">{{ $conditionalCount ?? 0 }}</h3>
                    </div>
            ...
            <div class="card text-center" style="background-color: #87431D; height: 160px; border: none; box-shadow: 0 4px 6px rgba(0,0,0,0.1); color: white;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h3 class="fw-bold m-0 text-white">{{ $unconditionalCount ?? 0 }}</h3>
                    </div>
            ...
            <div class="card text-center" style="background-color: #C69749; height: 160px; border: none; box-shadow: 0 4px 6px rgba(0,0,0,0.1); color: black;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h3 class="fw-bold m-0" style=" color: rgb(247, 246, 246) ">{{ $underCasCount ?? 0 }}</h3>
                    </div>
            ...
            <div class="card text-center" style="background-color: #828383; height: 160px; border: none; box-shadow: 0 4px 6px rgba(0,0,0,0.1); color: white;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h3 class="fw-bold m-0 text-white">{{ $casDocumentCount ?? 0 }}</h3>
                    </div>
            ...
            <div class="card text-center" style="background-color: #673AB7; height: 160px; border: none; box-shadow: 0 4px 6px rgba(0,0,0,0.1); color: white;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h3 class="fw-bold m-0 text-white">{{ $visaProcessCount ?? 0 }}</h3>
                    </div>
            ...
            <div class="card text-center" style="background-color: #009688; height: 160px; border: none; box-shadow: 0 4px 6px rgba(0,0,0,0.1); color: white;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h3 class="fw-bold m-0 text-white">{{ $enrollmentCount ?? 0 }}</h3>
                    </div>
            ...
            <div class="card text-center" style="background-color: #c01414; height: 160px; border: none; box-shadow: 0 4px 6px rgba(0,0,0,0.1); color: white;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h3 class="fw-bold m-0 text-white">{{ $caseClosedCount ?? 0 }}</h3>
                    </div>
    ...
    <div style="flex: 1 0 14%; min-width: 140px; margin: 0 4px 15px 4px;">
        <a href="{{ route('manager.admission.rejection') }}" class="text-decoration-none">
            <div class="card text-center" style="background-color: #ff0000; height: 160px; border: none; box-shadow: 0 4px 6px rgba(0,0,0,0.1); color: white;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        <i class="fas fa-archive fa-2x"></i>
                        <h3 class="fw-bold m-0 text-white">{{ $rejectionCount ?? 0 }}</h3>
                    </div>
                    <h6 class="mt-3 mb-0 text-white"><strong>Rejected</strong></h6>
                    <button class="btn btn-sm mt-3" style="background-color: white; color: #080808; font-size: 11px; border: none;">View All</button>
                </div>
            </div>
        </a>
    ...
    <div style="flex: 1 0 14%; min-width: 140px; margin: 0 4px 15px 4px;">
        <a href="{{ route('manager.admission.withdrawn') }}" class="text-decoration-none">
            <div class="card text-center" style="background-color: #ff5252; height: 160px; border: none; box-shadow: 0 4px 6px rgba(0,0,0,0.1); color: white;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        <i class="fas fa-archive fa-2x"></i>
                        <h3 class="fw-bold m-0 text-white">{{ $withdrawnCount ?? 0 }}</h3>
                    </div>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-header mb-4 border-0 py-3 d-flex align-items-center justify-content-between"
                            ...
                            <a href="{{ route('manager.inquiries') }}" class="btn btn-sm btn-outline-primary">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-header mb-4 border-0 py-3 d-flex align-items-center justify-content-between"
                            ...
                            <a href="{{ route('manager.admission-dashboard') }}" class="btn btn-sm btn-outline-success">
                                <i class="fas fa-external-link-alt me-1"></i> View All
                            </a>
                        </div>
            ...
            <div class="card border-0 shadow-sm mt-4">
                <div class="card-header bg-primary border-0 py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('manager.allreports') }}" class="btn btn-sm custom-report-btn">
                ...
                <div class="card-footer bg-white border-0 py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('manager.allreports') }}" class="btn btn-sm btn-primary">
