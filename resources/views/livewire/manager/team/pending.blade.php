<div>
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center"
            style="background-color: #f1bf28; color: black;">
    ...
    <style>
            ...
            100% { opacity: 1; }
                        ...
                        <td style="vertical-align: middle; padding: 8px; white-space: normal;">
                            <strong
                                ...
                                {!! !empty($inquiry->assignedUser->username)
                                    ? e($inquiry->assignedUser->username)
                                    : '<span class="badge bg-light text-black">Null</span>' !!}
                            </strong>
                        </td>
                        <td style="vertical-align: middle; padding: 8px; white-space: nowrap; text-align: center;">
                            <span class="badge"
                                ...
                                <strong>
                                    {!! !empty($inquiry->inquiry_status)
                                        ? e(ucfirst($inquiry->inquiry_status))
                                        : '<span class="badge bg-light text-black">Null</span>' !!}
                                </strong>
                            </span>
                        </td>
        ...
        <livewire:manager.modalteam.editteampendinginquiry />
