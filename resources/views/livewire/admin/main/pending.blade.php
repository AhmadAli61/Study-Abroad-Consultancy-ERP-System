...
<style>
.bg-gradient-pending {
    background: linear-gradient(135deg, #ffc107 70%, #ffe083 100%) !important;
}
</style>
            ...
            transform: scale(1.05);
                            ...
                            @else background-color: #adb5bd; @endif"
                                                    ...
                                                    @elseif($inquiry->inquiry_status === 'pending' || is_null($inquiry->inquiry_status))
                                                        <i class="fas fa-exclamation-circle me-1" style="color: #000;"></i> <strong
                                                            style="color: #000;">Pending</strong>
                                                    @else
                                                ...
                                                <div class="mt-1">
                                                    <div class="d-flex justify-content-center">
                                                        @if(!empty($inquiry->budget))
                                                            ...
                                                            <div class="text-center city-display" @if($tooltip) title="{{ $tooltip }}" @endif
