<div>
    ...
    <div class=card>
      <div class="card-header bg-gradient-dead text-white py-4" style="border-radius: 12px 12px 0 0 !important;">
        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="mb-0 opacity-75">
                    Review inquiries that are marked as closed or inactive
                </p>
            </div>
            <div class="col-md-4">
...
<style>
.bg-gradient-dead {
    background: linear-gradient(135deg, #4b4b4b 70%, #f8f6f6 100%) !important;
}
</style>
        ...
        <div class=card>
            ...
            <i class="fas fa-list-ol" style="margin-right: 5px;"></i>
                        ...
                        <th style=vertical-align:middle;padding:10px;white-space:nowrap;width:12%><i class="fas fa-user"
                                style=margin-right:5px></i> Name</th>
                        <th style=vertical-align:middle;padding:10px;white-space:nowrap;width:12%><i
                                class="fas fa-phone" style=margin-right:5px></i> Phone</th>
                        <th style=vertical-align:middle;padding:10px;white-space:nowrap;width:10%><i
                                class="fas fa-calendar-alt" style=margin-right:5px></i> Type</th>
                        
                        <th style=vertical-align:middle;padding:10px;width:30%;white-space:normal><i
                                class="fas fa-reply" style=margin-right:5px></i> Response</th>
                        <th style=vertical-align:middle;padding:10px;white-space:nowrap;width:8%><i
                                class="fas fa-check-circle" style=margin-right:5px></i> Status</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    {{ ($inquiries->currentPage() - 1) * $inquiries->perPage() + $loop->iteration }}
                               ...
                               <td class="whitespace-normal break-words max-w-[150px]" style="padding: 8px;">
                                                <div style="border-left: 3px solid #6c757d; padding-left: 8px;">
                                                    <div
    ...
    <div class="notes-container" 
            ...
            <div class="chat-messages" style="padding: 12px;">
                ...
                <div class="message-header" style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 8px;">
                    ...
                    <div class="user-info" style="display: flex; align-items: center; gap: 6px;">
                        <div class="avatar" style="width: 24px; height: 24px; border-radius: 50%; background: linear-gradient(135deg, #a9a3f0 0%, #7367F0 100%); display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 11px;">
                            {{ $avatarLetter }}
                        </div>
                        <div>
                    ...
                    <div class="time-info-right" style="text-align: right;">
                        {{-- Main Time --}}
                        <div class="time-with-status" style="display: flex; align-items: center; gap: 6px; justify-content: flex-end; margin-bottom: 4px;">
                            <div class="status-indicator" 
                                style="width: 6px; height: 6px; border-radius: 50%; background-color: #48bb78;">
                            </div>
                            <div class="message-time" style="font-size: 10px; color: #718096;">
                        ...
                        @if($inquiry->updated_at != $inquiry->created_at)
                            <div style="font-size: 9px; color: #a0aec0; margin-bottom: 2px;">
                                Created: {{ $inquiry->created_at->format('M d, h:i A') }}
                            </div>
                        @endif
        ...
        @else
            ...
            <div class="empty-state" style="height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 20px 15px;">
                <div style="width: 40px; height: 40px; background: #f1f5f9; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-bottom: 8px;">
                    <svg style="width: 20px; height: 20px; color: #cbd5e0;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path>
                    </svg>
                </div>
                
                <div style="text-align: center; margin-bottom: 12px;">
                    <div style="font-weight: 600; color: #4a5568; margin-bottom: 2px; font-size: 12px;">No Response Yet</div>
                    <div style="font-size: 10px; color: #718096;">Waiting for counsellor's remarks</div>
                </div>

                @if($inquiry->assigned_at)
                    <div class="assignment-info" style="text-align: center;">
                        <div class="assigned-badge" 
                             style="display: inline-flex; align-items: center; gap: 6px; padding: 4px 10px; background: #e6fffa; border-radius: 12px; font-size: 10px;">
                            <div class="status-dot" style="width: 6px; height: 6px; border-radius: 50%; background-color: #38a169;"></div>
