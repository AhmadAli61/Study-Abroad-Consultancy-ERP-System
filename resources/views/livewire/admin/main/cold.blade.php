<div>
    ...
    <div class=card>
       <div class="card-header bg-gradient-cold text-white py-4" style="border-radius: 12px 12px 0 0 !important;">
        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="mb-0 opacity-75">
                    Manage and follow up on less active or older inquiries
                </p>
            </div>
            <div class="col-md-4">
...
<style>
.bg-gradient-cold {
    background: linear-gradient(135deg, #00bcd4 70%, #e3fcff 100%) !important;
}
</style>
                ...
                <tbody>
                    ...
                    {{ ($inquiries->currentPage() - 1) * $inquiries->perPage() + $loop->iteration }}
                                ...
                                <td class="whitespace-normal break-words max-w-[150px]" style="padding: 8px;">
                                                <div style="border-left: 3px solid #00CFE8; padding-left: 8px;">
                                                    <div
