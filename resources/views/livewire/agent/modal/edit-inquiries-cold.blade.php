                ...
                <div class="modal-body" style="padding: 1.5rem; overflow: auto; flex: 1; background: #f8f9fa;">
                    <form>
                        <div class="form-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1.25rem;">
                            ...
                            <div class="form-field" style="background: white; border-radius: 8px; padding: 1rem; box-shadow: 0 2px 6px rgba(0,0,0,0.05);">
                                <label class="form-label" style="display: block; font-weight: 600; margin-bottom: 0.5rem; color: #495057;">
                                    <i class="fas fa-globe me-1" style="color: #7367f0;"></i> Country
                                </label>
...
@endif
        ...
        <style>
            ...
            /* Response History Scrollbar Styling */
            .response-history-container::-webkit-scrollbar {
                width: 6px;
            }
            
            .response-history-container::-webkit-scrollbar-track {
                background: #f1f1f1;
                border-radius: 3px;
            }
            
            .response-history-container::-webkit-scrollbar-thumb {
                background: #cbd5e0;
                border-radius: 3px;
            }
            
            .response-history-container::-webkit-scrollbar-thumb:hover {
                background: #a0aec0;
            }
        </style>
    @endif
