<div>
    ...
    <div class="d-flex align-items-center gap-2">
        <!-- View Intakes Button -->
        <a href="{{ route('agent.all-intakes') }}" 
           class="btn btn-dark fw-bold d-flex align-items-center"
           style="background-color: #fdfdfc; color: #000; border: none; box-shadow: 0 0 4px rgba(0,0,0,0.2);">
            <i class="fas fa-eye me-2"></i> View Intakes
        </a>
