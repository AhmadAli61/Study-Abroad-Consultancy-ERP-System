            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="text-white mb-0 opacity-75" style="font-size: 1.1rem;">
                        <i class="fas fa-user-circle me-2"></i>{{ Auth::user()->name ?? 'Counsellor' }}
                    </p>
                </div>
            </div>
        </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-6">
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <strong style="color: #2c3e50;">{{ $report->dial_calls ?? 0 }}</strong>
                                                        </div>
                                                        <div>
                                                            <small class="text-muted d-block">Connect Calls</small>
                                                            <strong style="color: #2c3e50;">{{ $report->connect_calls ?? 0 }}</strong>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="mb-2">
                                                            <small class="text-muted d-block">Today Reg</small>
                                                        ...
                                                        <div>
                                                            ...
                                                            <strong style="color: #3498db;">{{ $report->interested_followups ?? 0 }}</strong>
                                                        </div>
                                                    </div>
                                                </div>
