<div>
    ...
    <div class="card">
        <div>
            <div class="card-header bg-gradient-pending text-dark py-4" style="border-radius: 12px 12px 0 0 !important;">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h2 class="mb-2" style="color: #000;">
                    <i class="fas fa-exclamation-circle me-2" style="color: #000;"></i>
                    Pending Inquiries
                </h2>
                <p class="mb-0 opacity-75" style="color: #000;">
                    Review inquiries awaiting response or further action
                </p>
            </div>
            <div class="col-md-4">
...
<style>
.bg-gradient-pending {
    background: linear-gradient(135deg, #f1bf28 70%, #ffe083 100%) !important;
}
</style>
            ...
            <i class="fas fa-list-ol" style="margin-right: 5px;"></i>
                            ...
                            <th style="vertical-align: middle; padding: 10px; white-space: normal; width: 35%;">
                                <i class="fas fa-comment-dots" style="margin-right: 5px;"></i> Remarks
                            </th>
                            <th style="vertical-align: middle; padding: 10px; white-space: nowrap; width: 12%;">
                                <i class="fas fa-graduation-cap" style="margin-right: 5px;"></i> Education
                            </th>
    ...
    <div style="border-left: 3px solid #f1bf28; padding-left: 8px;">
...
<td style="padding: 8px; word-break: break-word; overflow-wrap: break-word; max-width: 150px;">
    ...
    <span class="badge"
        style="font-size: 13px; padding: 4px 6px; background-color: #ffc107; color: #000;"
        ...
        <strong style="color: #000;">{{ ucfirst($inquiry->inquiry_status ?? 'Pending') }}</strong>
    </span>
    ...
    <div class="mt-1">
        <div class="d-flex justify-content-center">
            ...
            @endif
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center text-muted">No pending inquiries found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
 ...
 <!-- UPDATED MODALS: Added unique keys and wire:key attributes -->
    <livewire:agent.modal.editInquiriesPending 
        wire:key="edit-pending-modal-{{ time() }}" />
