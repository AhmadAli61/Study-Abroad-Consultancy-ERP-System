        ...
        <div class="p-4">
            <form wire:submit.prevent="saveInquiry">
                <div class="row g-3">
                    ...
                    <div class="col-12">
    <label class="form-label fw-semibold">
        <i class="fas fa-reply me-1 text-secondary"></i> Remarks
    </label>
    <textarea 
        class="form-control rounded" 
        wire:model.defer="newResponse" 
        rows="3"
        placeholder="Enter initial remarks for this inquiry."
    ></textarea>
    @error('newResponse') <span class="text-danger small">{{ $message }}</span> @enderror
