<div>
    ...
    <div class="card mt-2">
        <div class="card-header d-flex justify-content-between align-items-center"
            ...
            <div class="d-flex align-items-center gap-2">
                <i class="fas fa-graduation-cap fa-lg" style="color: #fdfcfc"></i>
                <h4 class="mb-0" style="color: #fcfcfc"><strong>Enrollment</strong></h4>
            </div>
    ...
    @php
        // Check if notes_history is already an array or needs decoding
        ...
        // Ensure it's an array and reverse it
...
<div class="message-bubble" style="background: #f7fafc; border-left: 3px solid {{ $userStyle['color'] }}; padding: 8px 12px; border-radius: 6px; margin-top: 6px; max-width: 100%;">
    ...
    <div class="d-flex flex-column align-items-center "
        ...
        <!-- Divider -->
        <hr class="mb-3" style="width: 80%; margin: 6px 0; border-top: 1px dashed #ccc;">
        ...
        wire:click="$dispatch('openAssignIntakeModal', {inquiryId: {{ $inquiry->id }}})"
        style="font-size: 11px; padding: 3px 8px;">
        <i class="fas fa-paper-plane me-1"></i> Intake
    </button>
        </div>
...
<livewire:admission.admission-team.modals.assign-intake 
    wire:key="assign-intake-modal-{{ time() }}" />
