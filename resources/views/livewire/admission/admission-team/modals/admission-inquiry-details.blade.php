            ...
            <div class="timeline-item mb-4 position-relative">
                ...
                <div class="ms-5 ps-3">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <span class="fw-semibold">{{ $note['user_name'] ?? (\Illuminate\Support\Str::contains($note['note'], ':') ? \Illuminate\Support\Str::before($note['note'], ':') : 'System') }}</span>
                    ...
                    <div class="card border-0 shadow-none bg-light" style="border-radius: 8px; border-left: 3px solid #4b6cb7 !important;">
                        <div class="card-body py-2">
                            @if(\Illuminate\Support\Str::contains($note['note'], ':'))
                                ...
                                @endphp
                                <div class="text-dark">{!! nl2br(e(trim($remainingText))) !!}</div>
                            @else
                                <div class="text-dark">{!! nl2br(e(trim($note['note']))) !!}</div>
                            @endif
                        </div>
                    </div>
                </div>
