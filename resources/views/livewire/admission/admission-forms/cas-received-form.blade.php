...
<div class="mb-4 document-section p-3 rounded bg-light">
    <h6 class="mb-3 fw-bold text-dark"><i class="fas fa-file-alt me-2" style="color: #828383;"></i> CAS Document</h6>
    <p class="text-muted small mb-3">Required for application processing</p>
    ...
    @elseif($existingCasDocument)
        <div class="selected-file alert alert-light">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-sm btn-outline-danger" wire:click="deleteCasDocument">
