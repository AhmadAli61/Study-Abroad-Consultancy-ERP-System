<!-- resources/views/livewire/admission-agent/modals/new-inquiry-modal.blade.php -->
<div>
    @if($showModal)
        ...
        <div class="flex-grow-1 d-flex align-items-center justify-content-between">
            ...
            @endif
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="saveNewInquiry">
                            <!-- Section Header -->
                    ...
                    <div class="modal-footer bg-light py-4 px-5 border-top">
                        ...
                        <button type="button" class="btn btn-sm btn-primary rounded-pill px-4 py-2 shadow-sm" 
                                wire:click="saveNewInquiry" wire:loading.attr="disabled">
