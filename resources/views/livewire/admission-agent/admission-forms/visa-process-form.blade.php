                ...
                <div class="upload-card card shadow-lg">
                    ...
                    <div class="card-body mt-4 bg-light">
                        <form wire:submit.prevent="submitVisaDocuments" enctype="multipart/form-data">
                            ...
                            <!-- Update this section before the submit button -->
<div class="mb-4 document-section p-3 rounded">
    <h6 class="mb-3 fw-bold text-dark">
        <i class="fas fa-user-lock me-2" style="color: #673AB7;"></i> Enrollment Logins (Required)
    </h6>
   
    <div class="form-group">
        <label for="enrollmentLogins" class="form-label small text-muted">
            Enter login credentials (format: username_or_email/password) <span class="text-danger">*</span>
        </label>
        <input 
            type="text" 
...
<!-- Change this section - Remove (Optional) -->
<div class="mb-4 document-section p-3 rounded">
    <h6 class="mb-3 fw-bold text-dark">
        <i class="fas fa-link me-2" style="color: #673AB7;"></i> Visa Application Links
    </h6>
