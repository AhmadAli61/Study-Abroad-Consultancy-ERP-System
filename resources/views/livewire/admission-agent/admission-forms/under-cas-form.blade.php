                    ...
                    <div class="card-body bg-light">
                        <form wire:submit.prevent="saveCasDocuments" enctype="multipart/form-data">
                            ...
                            <div class="mb-4 document-section p-3 rounded mt-3">
                                <h6 class="mb-3 fw-bold text-dark"><i class="fas fa-receipt me-2" style="color: #C69749;"></i> Fee Payment Voucher (Required)</h6>
                            ...
                            <div class="mb-4 document-section p-3 rounded">
                                <h6 class="mb-3 fw-bold text-dark"><i class="fas fa-landmark me-2" style="color: #C69749;"></i> Bank Statement (Required)</h6>
                                <div class="upload-area py-4 mb-2 text-center border-2 border-dashed rounded bg-white"
                            ...
                            <!-- TB Test Upload -->
                            <div class="mb-4 document-section p-3 rounded">
                                <h6 class="mb-3 fw-bold text-dark"><i class="fas fa-file-medical me-2" style="color: #C69749;"></i> TB Test Results (Required)</h6>
                                <div class="upload-area py-4 mb-2 text-center border-2 border-dashed rounded bg-white"
                                     id="tbTestDropzone"
                                     x-data="{ isUploading: false, progress: 0 }"
                                     x-on:livewire-upload-start="isUploading = true"
                            ...
                            <!-- Birth Certificate Upload -->
                                ...
                                <!-- Replace the existing CAS Shield Logins section with this -->
<div class="mb-4 document-section p-3 rounded">
    <h6 class="mb-3 fw-bold text-dark">
        <i class="fas fa-shield-alt me-2" style="color: #C69749;"></i> CAS Shield Logins <span class="text-danger">*</span>
    </h6>
