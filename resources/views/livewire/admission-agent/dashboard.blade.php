<div><div class="card border-0 shadow-lg">
    ...
    <div class="d-flex justify-content-between align-items-center p-3 rounded shadow-sm" 
        ...
        <a href="{{ route('admissionagent.allapplications') }}" 
    ...
    <!-- Rejection Card -->
    <div style="flex: 0 0 calc(16.66% - 15px); min-width: 150px; margin: 0 0 15px 0;">
        <a href="{{ route('admissionagent.rejected') }}" class="text-decoration-none">
    ...
    <div style="flex: 0 0 calc(16.66% - 15px); min-width: 150px; margin: 0 0 15px 0;">
        <a href="{{ route('admissionagent.withdrawn') }}" class="text-decoration-none">
    ...
    <div class="col-lg-6 mb-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header mb-3 border-0 py-3 d-flex align-items-center justify-content-between"
                ...
                <a href="{{ route('admissionagent.allapplications') }}" class="btn btn-sm btn-outline-primary">
                ...
                @if($totalCount > 0)
                    @foreach($statusDistribution as $status)
                        @php
                            ...
                            $statusInfo = $this->getApplicationStatusInfo($status['inquiry_status']);
                        @endphp
                        <div class="mb-3">
                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body">
                                    ...
                                    <div class="row text-center">
                                        @php
                                            $bestMonth = $monthlyProgress->sortByDesc('total_applications')->first();
                                            $mostEfficient = $monthlyProgress->sortByDesc('completion_rate')->first();
                                            $currentMonth = $monthlyProgress->where('month', date('n'))->first();
                                        @endphp
                                        
                                        <div class="col-md-4 mb-3">
                                            <div class="p-3 border rounded">
                                                <i class="fas fa-crown fa-2x text-warning mb-2"></i>
                                                <h6 class="fw-bold">Best Performing Month</h6>
                                                <p class="mb-1 text-success fw-semibold">{{ $bestMonth->month_name ?? 'N/A' }}</p>
                                                <small class="text-muted">{{ $bestMonth->total_applications ?? 0 }} Applications</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="p-3 border rounded">
                                                ...
                                                <h6 class="fw-bold">Most Efficient Month</h6>
                                                <p class="mb-1 text-success fw-semibold">{{ $mostEfficient->month_name ?? 'N/A' }}</p>
                                                <small class="text-muted">{{ $mostEfficient->completion_rate ?? 0 }}% Completion</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="p-3 border rounded">
                                                ...
                                                <h6 class="fw-bold">Current Month Progress</h6>
                                                <p class="mb-1 text-info fw-semibold">{{ $currentMonth->total_applications ?? 0 }} Applications</p>
                                                <small class="text-muted">{{ $currentMonth->completion_rate ?? 0 }}% Complete</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="col-12">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header mb-3 border-0 py-3 d-flex align-items-center justify-content-between"
                ...
                <a href="{{ route('admissionagent.allapplications') }}" class="btn btn-sm btn-outline-primary fw-semibold">
                    <i class="fas fa-external-link-alt me-1"></i> View All
                </a>
            </div>
