<div>
    ...
    <div class="card mt-2">
        <div class="card-header d-flex justify-content-between align-items-center"
            style="background-color:#ff5252; color:#fdfcfc;">
            <div class="d-flex align-items-center gap-3">
                <div class="position-relative">
                    <i class="fas fa-user-slash fa-2x" style="color:#fdfcfc"></i>
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-light text-dark" style="font-size: 0.75rem;">
                        {{ $withdrawnInquiries->total() }}
                    </span>
                </div>
                <h4 class="mb-0 text-white"><strong>Withdrawn Applications</strong></h4>
            </div>
            ...
            @if($withdrawnInquiries->count() > 0)
                <div class="table-responsive">
                    <table class="table table-bordered align-middle text-center" style="font-size: 15px;">
                        ...
                        <tbody>
                            @foreach($withdrawnInquiries as $inquiry)
                                <tr style="text-align: left" id="inquiry-{{ $inquiry->id }}">
                                    <td style="vertical-align: middle; text-align: center;">
                                        {{ ($withdrawnInquiries->currentPage() - 1) * $withdrawnInquiries->perPage() + $loop->iteration }}
                                    </td>
                                    ...
                                    <td style="vertical-align: middle; padding: 8px; white-space: nowrap; text-align: center;">
                                        <div class="d-flex flex-column gap-1 align-items-center">
                                            <span class="badge"
                                                style="font-size: 13px; padding: 4px 6px; background-color: #ff5252; 
                                                color: #fff;"
    ...
    <i class="fas fa-plus "></i>
                ...
                <div class="mt-2">
                    {{ $withdrawnInquiries->links('pagination::bootstrap-5') }}
                </div>
            @else
                <div class="text-center py-4">
                    <span class="badge bg-light text-black" style="font-size: 14px; padding: 8px 16px;">No withdrawn inquiries found</span>
                </div>
            @endif
        </div>
    </div>
