<!-- underassessment.blade.php (admission agent portal) -->
<div>
    ...
    <div class="card-header d-flex justify-content-between align-items-center"
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <h4 class="mb-0" style="color: #fcfcfc"><strong>Under Assessment Inquiries</strong></h4>
        </div>
        ...
        overflow-wrap: break-word;
                        ...
                        <td style="vertical-align: middle; padding: 8px; white-space: nowrap; text-align: center;">
                            <div class="d-flex flex-column gap-1 align-items-center">
                                <span class="badge"
                                    style="font-size: 13px; padding: 4px 6px; background-color: #517577; 
                                    color: #fff;"
