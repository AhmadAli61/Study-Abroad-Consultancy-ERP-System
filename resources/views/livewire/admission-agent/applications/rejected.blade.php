<div>
    <!-- Add the cards section at the top -->
    <div class="d-flex flex-wrap justify-content-start" style="gap: 15px;">
        ...
        <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
            <a href="{{ route('admissionagent.allapplications') }}" class="text-decoration-none">
        ...
        <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
            <a href="{{ route('admissionagent.underassessment') }}" class="text-decoration-none">
        ...
        <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
            <a href="{{ route('admissionagent.processed') }}" class="text-decoration-none">
        ...
        <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
            <a href="{{ route('admissionagent.conditionaloffers') }}" class="text-decoration-none">
        ...
        <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
            <a href="{{ route('admissionagent.unconditionaloffers') }}" class="text-decoration-none">
        ...
        <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
            <a href="{{ route('admissionagent.undercas') }}" class="text-decoration-none">
        ...
        <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
            <a href="{{ route('admissionagent.casreceived') }}" class="text-decoration-none">
        ...
        <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
            <a href="{{ route('admissionagent.visaprocess') }}" class="text-decoration-none">
        ...
        <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
            <a href="{{ route('admissionagent.enrollment') }}" class="text-decoration-none">
        ...
        <div style="flex: 1 0 15.5%; min-width: 150px; margin: 0 4px 15px 4px;">
            <a href="{{ route('admissionagent.caseclosed') }}" class="text-decoration-none">
    ...
    <div class="card mt-2">
        <div class="card-header d-flex justify-content-between align-items-center"
            style="background-color:#ff0000; color:#fdfcfc;">
            <div class="d-flex align-items-center gap-3">
                <div class="position-relative">
                    <i class="fas fa-times-circle fa-2x" style="color:#fdfcfc"></i>
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-dark text-white" style="font-size: 0.75rem;">
                        {{ $rejectedInquiries->total() }}
                    </span>
                </div>
                <h4 class="mb-0 text-white"><strong>Rejected Inquiries</strong></h4>
            </div>
            ...
            @if($rejectedInquiries->count() > 0)
                <div class="table-responsive">
                    <table class="table table-bordered align-middle text-center" style="font-size: 15px;">
                        ...
                        <tbody>
                            @foreach($rejectedInquiries as $inquiry)
                                <tr style="text-align: left" id="inquiry-{{ $inquiry->id }}">
                                    <td style="vertical-align: middle; text-align: center;">
                                        {{ ($rejectedInquiries->currentPage() - 1) * $rejectedInquiries->perPage() + $loop->iteration }}
                                    </td>
                                    ...
                                    <td style="vertical-align: top; padding: 6px; background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%);">
                                        <!-- Notes section (same as your sample) -->
                                    ...
                                    <td style="vertical-align: middle; padding: 8px; white-space: nowrap; text-align: center;">
                                        <div class="d-flex flex-column gap-1 align-items-center">
                                            <span class="badge"
                                                style="font-size: 13px; padding: 4px 6px; background-color: #ff0000; 
                                                color: #fff;"
        ...
        wire:click="$dispatch('openNewInquiryModal', { parentId: {{ $inquiry->id }} })"
    ...
    <i class="fas fa-plus "></i>
                ...
                <div class="mt-2">
                    {{ $rejectedInquiries->links('pagination::bootstrap-5') }}
                </div>
            @else
                <div class="text-center py-4">
                    <span class="badge bg-light text-black" style="font-size: 14px; padding: 8px 16px;">No rejected inquiries found</span>
                </div>
            @endif
        </div>
    </div>
    <!-- UPDATED MODALS: Added unique keys and wire:key attributes -->
    <livewire:admission-agent.modals.refine-admission-inquiry 
        wire:key="refine-modal-{{ time() }}" />
    
    <livewire:admission-agent.modals.admission-inquiry-overview 
        wire:key="overview-modal-{{ time() }}" />
    
    <livewire:admission-agent.modals.update-inquiry-chat 
        wire:key="chat-modal-{{ time() }}" />
    
    <livewire:admission-agent.modals.new-inquiry-modal 
        wire:key="new-inquiry-modal-{{ $search }}" />
