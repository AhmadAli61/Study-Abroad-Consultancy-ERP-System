                    ...
                    <thead class="table-light">
                        <tr>
                            ...
                            <th style="vertical-align: middle; padding: 10px; white-space: nowrap; width: 12%;">
                                <i class="fas fa-passport" style="margin-right: 5px;"></i> Passport
                            </th>
                            ...
                            <th style="vertical-align: middle; padding: 10px; white-space: normal; width: 25%;">
                                <i class="fas fa-sticky-note" style="margin-right: 5px;"></i> Visa Status & Notes
                            </th>
                            <th style="vertical-align: middle; padding: 10px; white-space: nowrap; width: 2%;">
                                <i class="fas fa-edit" style="margin-right: 5px;"></i> Actions
                            </th>
                        </tr>
                    </thead>
                    <tbody>
...
<div class="message-bubble" style="background: #f7fafc; border-left: 3px solid {{ $userStyle['color'] }}; padding: 8px 12px; border-radius: 6px; margin-top: 6px; max-width: 100%;">
        ...
        overflow-wrap: break-word;
                            ...
                            <td style="vertical-align: middle; padding: 8px; white-space: nowrap; text-align: center;">
                                <div class="d-flex flex-column gap-1 align-items-center">
                                    <span class="badge"
                                        style="font-size: 13px; padding: 4px 6px; background-color: #673AB7; 
                                        color: #fff;"
    ...
    <i class="fas fa-plus "></i>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center text-muted">No visa process applications found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
   ...
   <!-- UPDATED MODALS: Added unique keys and wire:key attributes -->
    ...
    <livewire:admission-agent.modals.new-inquiry-modal 
        wire:key="new-inquiry-modal-{{ time() }}" />
