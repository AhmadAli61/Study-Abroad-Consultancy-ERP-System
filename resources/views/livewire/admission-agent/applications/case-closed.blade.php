    ...
    <div class="card mt-2">
       <div class="card-header d-flex justify-content-between align-items-center"
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <h4 class="mb-0" style="color: #fcfcfc"><strong>Closed Cases</strong></h4>
        </div>
        
        <!-- Search input group - UPDATED TO MATCH REFERENCE -->
                ...
                <table class="table table-bordered align-middle text-center" style="font-size: 15px;">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th style="vertical-align: middle; padding: 10px; white-space: nowrap; width: 2%;">
                                <i class="fas fa-history" style="margin-right: 5px;"></i> Actions
                            </th>
                        </tr>
                    </thead>
                    <tbody>
...
<div class="message-bubble" style="background: #f7fafc; border-left: 3px solid {{ $userStyle['color'] }}; padding: 8px 12px; border-radius: 6px; margin-top: 6px; max-width: 100%;">
        ...
        overflow-wrap: break-word;
                            ...
                            <td style="vertical-align: middle; padding: 8px; white-space: nowrap; text-align: center;">
                                <div class="d-flex flex-column gap-1 align-items-center">
                                    <!-- New button showing last_inquiry_status -->
                                    ...
                                    <span class="badge"
                                        style="font-size: 13px; padding: 4px 6px; background-color: #c01414; 
                                        color: #fff;"
                                        title="Closed on: {{ $inquiry->updated_at ? \Carbon\Carbon::parse($inquiry->updated_at)->format('M d, Y h:i A') : 'N/A' }}">
    ...
    <i class="fas fa-plus "></i>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center text-muted">No closed cases found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
