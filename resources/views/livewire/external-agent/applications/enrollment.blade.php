...
{{-- Under Assessment Inquiries --}}
    ...
    <div class="d-flex align-items-center gap-2">
        <!-- View Intakes Button -->
         <a href="{{ route('external-agent.all-intakes') }}" 
    ...
    <div class="d-flex flex-column gap-1 align-items-center">
        ...
        <div class="d-flex gap-1">
            ...
            <button class="btn btn-sm btn-info" 
                    wire:click="$dispatch('showDetailsExternal', { id: {{ $inquiry->id }} })"
                    style="font-size: 12px; padding: 3px 6px; white-space: nowrap;">
...
@if($registeredInquiries->count() > 0)
    ...
    @endif
<livewire:external-agent.modal.edit-registered-application
        wire:key="update-modal-{{ time() }}" />
           

<livewire:external-agent.modal.edit-registered-application-chat
        wire:key="chat-modal-{{ time() }}" />

  <livewire:external-agent.modal.view-registered-application-details
        wire:key="details-modal-{{ time() }}" />
            <livewire:external-agent.modal.create-new-application
