...
<div class="file-upload-card">
    ...
    @endif
                                ...
                                <!-- Student Consent -->
<div class="file-upload-card">
<label class="form-label fw-semibold"><span class="badge bg-primary me-2">12</span>Student Consent Letter</label>    
    <div class="upload-area py-2 mb-1 text-center border-2 border-dashed rounded bg-white"
         x-data="{ isUploading: false, progress: 0 }"
         x-on:livewire-upload-start="isUploading = true"
         x-on:livewire-upload-finish="isUploading = false"
        ...
        <input type="file" wire:model="student_consent" id="studentConsent" class="d-none" accept=".pdf">
