                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <p class="mb-0 opacity-75">
                            Manage and review intake periods with your submitted students
                        </p>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 mb-4">
                            <div class="card border-0 shadow-sm h-100 intake-card">
                                ...
                                <div class="d-flex justify-content-between align-items-center p-3 rounded-top"
                                    ...
                                    <!-- Right: Student Count (Only external agent's students) -->
                                    <div class="text-end">
                                ...
                                <div class="card-footer bg-white border-0 py-3 rounded-bottom">
                                    <a href="{{ route('external-agent.intake-details', $intake->id) }}" 
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">
                        ...
                        @else
                            No intakes found with your submitted students.
                        @endif
                    </p>
                    @if($searchTerm)
