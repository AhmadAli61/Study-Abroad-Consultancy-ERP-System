...
class EditRegisteredApplication extends Component
{
    use WithFileUploads;
    ...
    #[On('editAdmissionLead')]
    public function editAdmissionLead($id)
    {
    ...
    public function update()
    {
        $validated = $this->validate([
            ...
            'extra11' => 'nullable|file|mimes:pdf|max:5120', // Add this line
        ]);
        ...
        session()->flash('message', 'Admission application updated successfully.');
        $this->showModal = false;
        $this->notes = '';

            // Get the referring URL and add page=1 parameter
    $referrer = $this->referrer ?: route('externalagent.all-applications');
    ...
    public function render()
    {
        ...
        // Get agents for assigned_to dropdown
        $agents = \App\Models\User::where('role', 'externalagent')->get();

        return view('livewire.external-agent.modal.edit-registered-application', [
