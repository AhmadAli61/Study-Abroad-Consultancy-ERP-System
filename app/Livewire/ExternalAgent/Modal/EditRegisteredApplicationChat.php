...
class EditRegisteredApplicationChat extends Component
{
    ...
    public function update()
    {
        ...
        return $this->referrer 
            ...
            : redirect()->route('externalagent.all-applications');

    }
    public function render()
    {
        return view('livewire.external-agent.modal.edit-registered-application-chat');
    }
}
