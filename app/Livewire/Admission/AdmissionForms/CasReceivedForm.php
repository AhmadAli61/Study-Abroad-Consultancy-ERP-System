...
class CasReceivedForm extends Component
{
    ...
    {
        // Adjust validation based on whether interview pass is needed
        ...
        // Update the existing admission form record
    ...
    {
        return view('livewire.admission.admission-forms.cas-received-form')
