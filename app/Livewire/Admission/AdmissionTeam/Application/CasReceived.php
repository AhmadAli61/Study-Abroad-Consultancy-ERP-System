...
class CasReceived extends Component
{
    ...
    public $search = '';
    public $statusFilter = 'casreceived'; // Default to CAS received status
    ...
    protected function loadCounts()
{
    ...
    public function render()
    {
        $query = RegisteredInquiry::query()
            ...
            ->where('inquiry_status', '!=', 'withdrawn')
            ->where('inquiry_status', 'casreceived') // Filter for CAS received status
        ...
        return view('livewire.admission.admission-team.application.cas-received', [
