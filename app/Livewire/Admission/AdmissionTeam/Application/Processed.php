...
class Processed extends Component
{
    ...
    public $search = '';
    public $statusFilter = 'processed'; // Default to processed status
    ...
    protected function loadCounts()
{
    ...
    public function render()
    {
        $query = RegisteredInquiry::query()
            ...
            ->where('inquiry_status', '!=', 'withdrawn')
            ->where('inquiry_status', 'processed') // Filter for processed status
        ...
        return view('livewire.admission.admission-team.application.processed', [
            ...
            'casDocumentCount' => $this->casReceivedCount, // Note: Keeping original blade variable name
