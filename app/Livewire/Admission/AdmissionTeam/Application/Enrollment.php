...
class Enrollment extends Component
{
    ...
    public $search = '';
    public $statusFilter = 'enrollment';
    ...
    // Count properties remain the same
    public $totalCount;
    ...
    // Remove validation rules for modal
  ...
  protected function loadCounts()
{
    ...
    // Update this method to use the component
    public function assignToIntake($inquiryId)
    {
        $this->dispatch('openAssignIntakeModal', inquiryId: $inquiryId);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admission.admission-team.application.enrollment', [
    ...
    protected $listeners = [
        ...
        'intakeAssigned' => '$refresh' // Add this to refresh when intake is assigned
    ];
