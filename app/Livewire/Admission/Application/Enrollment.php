...
class Enrollment extends Component
{
    ...
    public $search = '';
    public $statusFilter = 'enrollment'; // Default to enrollment status
  ...
  protected function loadCounts()
{
    ...
    public function render()
    {
        ...
        $query = RegisteredInquiry::query()
            ...
            ->where('inquiry_status', 'enrollment') // Filter for enrollment status
              // UPDATED: Search logic to match reference (more focused search)
        ...
        return view('livewire.admission.application.enrollment', [
