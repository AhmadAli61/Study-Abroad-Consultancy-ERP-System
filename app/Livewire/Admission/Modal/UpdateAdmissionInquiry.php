...
class UpdateAdmissionInquiry extends Component
{
    use WithFileUploads;
    ...
    // In UpdateAdmissionInquiry.php component
 ...
 if ($this->original_status === 'caseclosed' || $this->original_status === 'rejection' || $this->original_status === 'withdrawn') {
    ...
    {
        return view('livewire.admission.modal.update-admission-inquiry');
    }
