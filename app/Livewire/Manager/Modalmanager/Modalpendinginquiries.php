...
class Modalpendinginquiries extends Component
{
    ...
    public function update()
    {
        ...
        return redirect()->route('manager.inquiry.pending', [
    ...
    {
        return view('livewire.manager.modalmanager.modalpendinginquiries');
    }
}