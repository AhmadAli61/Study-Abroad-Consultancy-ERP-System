...
class AddNewApplicationManager extends Component
{
    use WithFileUploads;
    ...
    #[On('openAddNewApplicationManagerModal')]
    public function openAddNewApplicationManagerModal($parentId)
    {
        ...
        session(['add_application_manager_referrer' => url()->previous()]);
        $this->showModal = true;
    ...
    public function saveNewApplication()
    {
        ...
        try {
            ...
            $newInquiry = RegisteredInquiry::create([
                ...
                // For manager portal: set status to unassigned so it appears on admission assign page
                'assigned_to' => null,
                'status' => 'unassigned',
                'inquiry_status' => 'underassessment',
                'assigned_at' => null,
                
                // Copy notes and history
                'notes' => $parent->notes,
                'notes_history' => $parent->notes_history,
            ...
            $referrer = session('add_application_manager_referrer', route('manager.all-applications'));
    ...
    {
        return view('livewire.manager.modal-manager.add-new-application-manager');
    }
}