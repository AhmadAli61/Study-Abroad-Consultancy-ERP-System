...
class Modalhotinquiries extends Component
{
    ...
    public function update()
    {
        ...
        if (strtolower($this->inquiry_status) === 'registered') {
            ...
            return redirect()->route('manager.registered', [
        ...
        return redirect()->route('manager.inquiry.hot', [
    ...
    {
        return view('livewire.manager.modalmanager.modalhotinquiries');
    }
}