...
class EditAdmissionInquiryChat extends Component
{
    ...
    #[On('editAdmissionInquiryChat')]
    public function editAdmissionInquiryChat($id, $referrer = null)
    {
    ...
    public function update()
    {
        ...
        return $this->referrer 
            ...
            : redirect()->route('manager.admission-dashboard');
    }

    public function render()
    {
        return view('livewire.manager.modal-manager.edit-admission-inquiry-chat');
    }
}