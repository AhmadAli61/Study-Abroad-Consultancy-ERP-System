...
class AddReport extends Component
{
    ...
    public function mount($date = null)
    {
        ...
        // Reset form to ensure it starts empty
        $this->resetForm();
    }
    ...
    public function submitReport()
    {
        ...
        // Dispatch event to refresh the reminder
    ...
    {
        return view('livewire.manager.report.add-report')->layout('layouts.managerdashboard');
    }
}