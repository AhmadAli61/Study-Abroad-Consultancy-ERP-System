...
class DailyReportsReminder extends Component
{
    ...
    public function checkReportSubmission()
    {
        ...
        if (Route::currentRouteName() === 'manager.addreport') {
        ...
        if (!empty($missingDates)) {
            ...
            if (count($missingDates) > 1) {
                ...
                $this->reminderMessage = "You have missing reports for the following dates:<br>" . $dateList . 
                    "<br><br>Please submit your reports starting with " . $missingDates[0]->format('F j, Y');
            } else {
    ...
    {
        return view('livewire.manager.report.daily-reports-reminder');
    }
}