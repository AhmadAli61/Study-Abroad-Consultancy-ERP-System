...
class Processed extends Component
{
    ...
    public function render()
    {
        ...
        // Fetch only processed inquiries for this manager
        $processedInquiries = RegisteredInquiry::where('users_id', $manager->id)
        ...
        return view('livewire.manager.admission.processed', [
