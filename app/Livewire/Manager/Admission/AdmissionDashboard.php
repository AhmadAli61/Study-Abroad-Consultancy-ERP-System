...
class AdmissionDashboard extends Component
{
    ...
    public function render()
    {
        ...
        // Manager can see only inquiries assigned to them
        $registeredInquiries = RegisteredInquiry::where('users_id', $manager->id)
        ...
        return view('livewire.manager.admission.admission-dashboard', [
