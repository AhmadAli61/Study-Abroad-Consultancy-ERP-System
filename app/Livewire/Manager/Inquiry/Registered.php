...
class Registered extends Component
{
    ...
    public function getManagerPrefix()
    {
    ...
    public function saveDocuments()
    {
        ...
        try {
            ...
            $currentNote = $this->getManagerPrefix() . $this->notes;
            ...
            $registeredInquiry = RegisteredInquiry::create([
                ...
                'notes' => $this->getManagerPrefix() . $this->notes,
            ...
            return redirect()->route('manager.admission-dashboard');
    ...
    {
        return view('livewire.manager.inquiry.registered')->layout('layouts.managerdashboard');
    }
}