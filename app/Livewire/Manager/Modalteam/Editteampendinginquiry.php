...
class Editteampendinginquiry extends Component
{
        ...
        public function update()
    {
        ...
        return redirect()->route('manager.team.inquiry.pending', [
    ...
    {
        return view('livewire.manager.modalteam.editteampendinginquiry');
    }
}
