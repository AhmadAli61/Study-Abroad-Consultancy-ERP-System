  ...
  protected function loadCounts()
    ...
    public function render()
    {
        ...
        if ($this->hasActiveFilters()) {
            $registeredInquiries = $query->paginate(1000); // Show all when filters are active
        } else {
            $registeredInquiries = $query->paginate(10); // Normal pagination
        }

        return view('livewire.admin.admission.applications.all-students', [
