...
class Rejection extends Component
{
    use WithPagination;
    public $search = '';
    public $statusFilter = 'rejection'; // Default to rejection status
     ...
     protected function loadCounts()
{
    ...
    {
        $rejectedInquiries = RegisteredInquiry::where('inquiry_status', 'rejection')
        ...
        return view('livewire.admin.admission.applications.rejection', [
