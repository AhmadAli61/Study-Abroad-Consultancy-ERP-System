...
class EditInquiriesPending extends Component
{
    ...
    public function update()
    {
        ...
        // Use Eloquent model instead of direct query to trigger events
        ...
        return redirect()->route('agent.inquiry.pending', [
    ...
    {
        return view('livewire.agent.modal.edit-inquiries-pending');
    }
}