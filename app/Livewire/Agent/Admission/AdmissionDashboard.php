...
namespace App\Livewire\Agent\Admission;
   ...
   protected function loadCounts()
{
    ...
    // Base query for counts - only show inquiries for this agent and where intake_id is null
    $query = RegisteredInquiry::where('users_id', $agent->id)
                              ->whereNull('intake_id');
    ...
    public function render()
    {
        ...
        return view('livewire.agent.admission.admission-dashboard', [
    ...
    {
        $this->dispatch('showDetails', id: $id)->to(\App\Livewire\Agent\Modal\Viewadmissioninquiry::class);
    }
