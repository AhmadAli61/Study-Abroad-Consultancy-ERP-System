    ...
    public function render()
    {
        ...
        $inquiries = Inquiiry::where('assigned_to', $userId)
            ->where(function ($query) {
                $query->whereNull('inquiry_status')->orWhere('inquiry_status', 'pending');
            })
        ...
        return view('livewire.agent.inquiry.pending', compact('inquiries'))->layout('layouts.agentdashboard');
    }
