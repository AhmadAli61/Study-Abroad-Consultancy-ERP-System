...
class VisaProcess extends Component
{
    ...
    public $search = '';
    public $statusFilter = 'visaprocess'; // Default to visaprocess status
...
protected function loadCounts()
{
    ...
    public function render()
    {
        ...
        $query = RegisteredInquiry::query()
            ...
            ->where('inquiry_status', 'visaprocess') // Filter for visa process status
        ...
        return view('livewire.admission-agent.applications.visa-process', [
  ...
  // Search functionality methods - ADDED TO MATCH REFERENCE
